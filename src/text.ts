...
export const TEXT = {
  ...
  PROJECTS: {
    MESSBOARD: {
      ...
      DESC: "Mess Board is a web application designed to facilitate the storage of various data on a canvas. It supports text, markdown, code, images, and allows users to save web URLs. Mess Board provides a convenient space to store information without the need for meticulous organization typically associated with traditional note-taking methods.",
