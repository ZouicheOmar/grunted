...
const Navbar = () => {
  ...
  return (
    <>
      <div className="hidden md:block sticky w-1/4 bg-indigo-950 max-h-screen top-0 left-0 border-r-[1px] border-r-indigo-500 ">
        <div className="mt-[5rem] flex flex-col justify-between align-center h-1/3">
          ...
          <div className="navbar md:text-xl text-3xl gap-4 flex flex-col min-h-fit">
            ...
            <div className="text-lg dark:text-white mt-[25%] flex flex-wrap gap-x-2 toanim pl-[2rem]">
              <a
                href="https://github.com/ZouicheOmar"
                target="blank"
                className="flex gap-2 items-center hover:cursor-pointer"
